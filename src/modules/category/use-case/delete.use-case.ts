import { DeleteGoalRepository } from "../model/repository/delete.repository.js";
...
export class DeleteGoalUseCase {
  ...
  public async handle(id: string, options?: DeleteOptionsInterface) {
    try {
      ...
      const deleteGoalRepository = new DeleteGoalRepository(this.db);
      await deleteGoalRepository.handle(id, options);

...
import { RetrieveAllCommentRepository } from "../model/repository/retrieve-all.repository.js";
...
export class RetrieveAllCheersUseCase {
  ...
  public async handle(post_id: any, postType: any, options?: RetrieveAllOptionsInterface, page = 1, limit = 10) {
    try {
      ...
      const retrieveAllCheerRepository = new RetrieveAllCommentRepository(this.db);
